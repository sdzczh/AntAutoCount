...
public class MatchUtils {
	...
	public static Double divide(Double d1,Double d2){
		BigDecimal bd1 = new BigDecimal(d1.toString()).setScale(2, BigDecimal.ROUND_HALF_DOWN);
		BigDecimal bd2 = new BigDecimal(d2.toString()).setScale(2, BigDecimal.ROUND_HALF_DOWN);
		return bd1.divide(bd2).setScale(2, BigDecimal.ROUND_HALF_DOWN).doubleValue();
	}
	 ...
	 * @日期 2017-6-17
	 */
	public static Map<String,Object> checkProfit(int day){
		String profit="";
		String after="";
		int down=0;
		if(day<=15){
...
//		System.out.println(s);
		...
		int day = 14;
		Map<String,Object> map = checkProfit(day);

...
public class GolbParams{
	...
	/*增值包等级*/
	public static final String POUNDAGE_LEVEL_1 = "POUNDAGE_LEVEL_1";
	public static final String POUNDAGE_LEVEL_2 = "POUNDAGE_LEVEL_2";
	public static final String POUNDAGE_LEVEL_3 = "POUNDAGE_LEVEL_3";
	public static final String POUNDAGE_LEVEL_4 = "POUNDAGE_LEVEL_4";
	public static final String POUNDAGE_LEVEL_5 = "POUNDAGE_LEVEL_5";
	
	public static final String TABLENAME="t_profit";
